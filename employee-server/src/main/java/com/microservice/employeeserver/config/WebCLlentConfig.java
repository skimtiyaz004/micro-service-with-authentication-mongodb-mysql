package com.microservice.employeeserver.config;
...
public class WebCLlentConfig {
    ...
    public DepartmentClient departmentClient(){
        HttpServiceProxyFactory httpServiceProxyFactory
                = HttpServiceProxyFactory.builder(WebClientAdapter.forClient(departmentWebClient()))
                .build();
